		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="col-lg-3">
					<div class="product-item">
						<figure>
							<img src="<?=base_url(); ?>assets/img/products/9.jpg" alt="">
							<div class="pi-meta">
								<div class="pi-m-left">
									<img src="<?=base_url(); ?>assets/img/icons/eye.png" alt="">
									<p>quick view</p>
				...
				<div class="col-lg-3">
					<div class="product-item">
						<figure>
							<img src="<?=base_url(); ?>assets/img/products/10.jpg" alt="">
							<div class="bache">NEW</div>
							<div class="pi-meta">
								<div class="pi-m-left">
									<img src="<?=base_url(); ?>assets/img/icons/eye.png" alt="">
				...
				<div class="col-lg-3">
					<div class="product-item">
						<figure>
							<img src="<?=base_url(); ?>assets/img/products/11.jpg" alt="">
							<div class="pi-meta">
								<div class="pi-m-left">
									<img src="<?=base_url(); ?>assets/img/icons/eye.png" alt="">
									<p>quick view</p>
				...
				<div class="col-lg-3">
					<div class="product-item">
						<figure>
							<img src="<?=base_url(); ?>assets/img/products/12.jpg" alt="">
							<div class="pi-meta">
								<div class="pi-m-left">
									<img src="<?=base_url(); ?>assets/img/icons/eye.png" alt="">
									<p>quick view</p>
